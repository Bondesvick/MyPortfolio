        ...
        $(window).on('load resize', function () {
            ...
            if (currMenuType !== menuType) {
                ...
                if (currMenuType === 'mobile') {
                    ...
                    //var logomobileMenu = $('#mainnav-mobi').find('ul.menu >li').first().before('<li id="logo" class="logo-mobi"><a asp-area="" asp-controller="Home" asp-action="Index" title="Logo"><h3 class= "widget-title larger lt-sp06 text-white" style = "font-size: 40px; font-weight: bold !important" ><span style="color: #627FFF !important;">Victor</span> Nwike </h3 ></a ></li>');
